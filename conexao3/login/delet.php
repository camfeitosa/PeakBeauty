...
<head>
    ...
    <title>Peak Beauty - Deletar Conta</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="../css/agend.css">
    <link rel="stylesheet" href="../css/cliente.css">
    <link rel="stylesheet" href="../css/delet.css">
       ...
       <div class="cliente">
        <div class="cnt-left">
            ...
            <a href="./delet.php" style="color: #2b2b2b;">
                <div class="clt-delet" style="border-left: solid 5px #8b660e;">
        ...
        ?>
                <form action="del.php" class="wrapper" method="POST">
                <h1> Digite sua senha antes de deletar a conta </h1><br><br>
		    <div class="input-data wrapper"><br>
			    <input type="password" class="text-input" required="" placeholder="******" name="senha_conf"/><br>
			<div class="underline"></div>	
		</div>
		<br/>
        <br/>
        <button class="b" type="submit" name="deletar" value="Deletar conta">Deletar conta</button>
		</form>
            </div>
        </div>
    </div>
